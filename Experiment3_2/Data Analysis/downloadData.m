...
%function downloadData(sub)
   ...
   %i = 0;
    ...
    for i = 1:tot
        ...
        sqlquery1 = ['SELECT * FROM ' tableName ' WHERE subject = "', name, '" AND (isResponseTrial = 1) AND (periSat = 0.3) AND (key_press = 80) AND internal_node_id LIKE "%12.0"'];
        ...
        sqlquery2 = ['SELECT * FROM ' tableName ' WHERE subject = "', name, '" AND (isResponseTrial = 1) AND (periSat = 0.4) AND (key_press = 80) AND internal_node_id LIKE "%12.0"'];
        ...
        sqlquery3 = ['SELECT * FROM ' tableName ' WHERE subject = "', name, '" AND (isResponseTrial = 1) AND (periSat = 0.5) AND (key_press = 80) AND internal_node_id LIKE "%12.0"'];
        ...
        sqlquery4 = ['SELECT * FROM ' tableName ' WHERE subject = "', name, '" AND (isResponseTrial = 1) AND (periSat = 0.6) AND (key_press = 80) AND internal_node_id LIKE "%12.0"'];
        ...
        sqlquery5 = ['SELECT * FROM ' tableName ' WHERE subject = "', name, '" AND (isResponseTrial = 1) AND (periSat = 0.7) AND (key_press = 80) AND internal_node_id LIKE "%12.0"'];
