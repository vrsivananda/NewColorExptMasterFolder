...
function output = psychometricFit(x,y,subjNum,condition,save)
    ...
    %Draw the horizontal line to the PSE
    hold on;
    plot([0.2,PSE],[0.5,0.5],'--','LineWidth',0.5,'Color','k');
    %Draw the vertical line to the PSE
    hold on;
    plot([PSE,PSE],[0,0.5],'--','LineWidth',0.5,'Color','k');
